...
// in cliente_flutter/test/mocks.dart.
...
import 'package:cliente_flutter/models/search_result.dart' as _i8;
import 'package:cliente_flutter/services/api_service.dart' as _i7;
...
class MockApiService extends _i1.Mock implements _i7.ApiService {
  ...
  @override
  _i3.Future<List<_i8.SearchResult>> fetchGoogleResults(String? searchTerm) =>
      (super.noSuchMethod(
        Invocation.method(
          #fetchGoogleResults,
          [searchTerm],
        ...
        returnValue:
            _i3.Future<List<_i8.SearchResult>>.value(<_i8.SearchResult>[]),
